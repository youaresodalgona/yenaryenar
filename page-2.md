...
**Repository:** `laravelkr/docs`  
**Updated:** 2020-09-22  
**Description:** 마이그레이션 설명의 스쿼싱 마이그레이션 항목이 ��가되었고, 컬럼 수정자의 명령어가 하나 추가되었습니다.  
...
**Repository:** `laravelkr/docs`  
**Updated:** 2020-03-28  
**Description:** 제거한 문��은 [라라벨 5.3 문서](https://github.com/laravel/docs/blob/5.3/configuration.md#retrieving-environme...  
